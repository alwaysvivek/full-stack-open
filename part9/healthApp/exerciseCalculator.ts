...
const analyzeTraining = (dailyExerciseHours: number[], target: number): Result => {
...
if (require.main === module) {
  try {
    ...
    console.log(analyzeTraining(dailyExerciseHours, targetAmount));
  } catch (error: unknown) {
...
export default analyzeTraining;