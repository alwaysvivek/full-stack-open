...
const computeMetabolicIndex = (height: number, weight: number): BmiCategory => {
...
if (require.main === module) {
  try {
    ...
    console.log(computeMetabolicIndex(height, weight));
  } catch (error: unknown) {
...
export default computeMetabolicIndex;